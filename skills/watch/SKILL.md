...
Learn from YouTube videos by sending to Gemini for transcription, then indexing to Jimmy.
...
| `scripts/save-learning.ts <title> <url> <id> <transcript> [cc]` | Save to Jimmy/memory/learnings/ |
...
Or manually create a learning file at `Jimmy/memory/learnings/YYYY-MM-DD_video-slug.md`.

### Step 4: Index to Jimmy
