...
Sort all Jimmy/ files by modification time, read the most recent:
...
2. Read latest handoff: ls -t Jimmy/inbox/handoff/*.md | head -1
3. Git status: git status --short
4. Tracks: cat Jimmy/inbox/tracks/INDEX.md 2>/dev/null
```
...
**Jimmy**: [Related past pattern, if any]
