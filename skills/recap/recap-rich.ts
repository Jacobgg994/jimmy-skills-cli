...
// Tracks
console.log("## TRACKS");
const tracksDir = join(ROOT, "Jimmy/inbox/tracks");
...
// Latest retro
console.log("\n---\n\n## LAST SESSION");
const retroDir = join(ROOT, `Jimmy/memory/retrospectives/${month}`);
...
// Handoff
const handoffDir = join(ROOT, "Jimmy/inbox/handoff");
