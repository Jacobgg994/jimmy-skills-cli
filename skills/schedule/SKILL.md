...
name: schedule
description: ดู schedule ผ่าน Jimmy API ใช้เมื่อพูดว่า schedule, upcoming events, what's on today, calendar
---
...
- Jimmy DB: `~/.Jimmy/Jimmy.db` → `schedule` table
